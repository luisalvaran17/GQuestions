      ...
      style={{
        ...
        <div className='container lg:ml-32 mx-16 mt-8 lg:text-base text-sm'>
          <div className="grid grid-cols-12">
            <div className="md:col-span-10 col-span-6">
              <h1 className='font-black xl:text-5xl md:text-4xl sm:text-2xl md:text-left md:mb-10 text-sm'>
                Parámetros de generación
              </h1>
            </div>
            <div className="md:col-span-2 col-span-6 justify-self-end">
              <UserMenu />
            </div>
          </div>

          <div className='grid grid-cols-12 xl:gap-x-32 lg:gap-x-16 lg:mb-32 xl:mb-44 md:gap-x-16 md:mb-20'>
          ...
          <div className='grid grid-rows lg:mx-0 mx-auto sm:col-span-6 col-span-12 md:col-span-4'>
            ...
            <div className='flex sm:mx-0 mx-auto'>
              <div className='grid grid-rows'>
                <div class='flex flex-col lg:text-base text-sm ml-1'>
                  <label class='inline-flex items-center mt-3 text-sm md:text-base'>
                    <input
                      type='checkbox'
          ...
          <div className='flex justify-end'>
            <button
              type='submit'
              className='z-10 block xl:w-1/6 w-40 sm:w-1/4 focus:outline-none bg-yellow-500 hover:bg-yellow-600 focus:bg-yellow-600 text-white rounded-lg py-2 font-semibold'
