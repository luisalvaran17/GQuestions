            ...
            <div className="sm:mx-4 mx-0 px-0 py-4 sm:py-4">
                <div className="flex items-center">
                    <div className="flex items-center text-gray-700 relative">
                        <div ref={componentGeneracionCircleRef} className="rounded-full shadow-xl transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-teal-600">
                    ...
                    <div className="flex items-center text-gray-700 relative">
                        <div ref={componentTextosCircleRef} className="rounded-full shadow-xl transition duration-500 ease-in-out h-12 w-12 py-3 border-2 bg-teal-600 border-teal-600">
                    ...
                    <div className="flex items-center text-gray-700 relative">
                        <div ref={componentPreguntasCircleRef} className="rounded-full shadow-xl transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
                    ...
                    <div className="flex items-center text-gray-700 relative">
                        <div ref={componentConfirmarCircleRef} className="rounded-full shadow-xl transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
