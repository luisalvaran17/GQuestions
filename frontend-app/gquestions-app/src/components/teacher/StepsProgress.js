                ...
                <div className="flex items-center">
                    <div className="flex items-center text-gray-700 dark:text-gray-100 relative">
                        <div ref={componentGeneracionCircleRef} 
                            className="rounded-full shadow-sm transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-teal-600">
                            <svg 
                        ...
                        <div ref={componentGeneracionTextRef} className="hidden sm:block absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase dark:text-gray-100 ">Parámetros</div>
                    </div>
                    <div ref={refLine1} className="flex-auto border-t-2 transition duration-500 ease-in-out"></div>
                    <div className="flex items-center text-gray-700 dark:text-gray-100 relative">
                        <div ref={componentTextosCircleRef} className="rounded-full shadow-sm transition duration-500 ease-in-out h-12 w-12 py-3 border-2 bg-teal-600 border-teal-600">
                    ...
                    <div className="flex items-center text-gray-700 dark:text-gray-100 relative">
                        <div ref={componentConfirmarCircleRef} className="rounded-full shadow-sm transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
                        ...
                        <div ref={componentConfirmarTextRef} className="hidden sm:block absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase dark:text-gray-100">Confirmar</div>
                    </div>
                </div>
            </div>
        </div>
