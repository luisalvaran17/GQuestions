        ...
        return (
            <div className="container mx-auto flex items-center justify-center h-screen">
                <Helmet>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 mx-auto bg-gray-100 rounded-l-xl shadow-lg items-center" >
                        
                        <div className="mx-auto px-16 py-16 bg-yellow-500 rounded-l-xl flex invisible lg:visible"> 
                        ...
                        <div className="grid grid-cols-1 mx-16">
                            <div className="grid grid-rows">

                                <h1 className="font-bold text-2xl text-gray-900 mb-8 text-center">INICIAR SESIÓN</h1>
                                <div className="grid grid-rows-2">
                                    <label for="" class="text-xs font-semibold px-1 text-gray-500 self-end py-2">Correo electrónico</label>
                                    <div className="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" class="text-sm w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-yellow-500" placeholder="example@gmail.com"/>
                                    </div>
                                </div>
                                <div className="grid grid-rows-2">
                                    <label for="" class="text-xs font-semibold px-1 text-gray-500 self-end py-2">Contraseña</label>
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <input type="password" class="text-sm w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-yellow-500" placeholder="Ingresa tu contraseña"/>
                                    </div>
                                </div>
                                <div>
                                    <label for="" className="text-xs font-semibold px-1 text-gray-500 self-end py-2">¿Olvidaste tu contraseña?</label>
                                    <span><a href="#" className="text-xs font-semibold px-1 text-blue-500 underline">Recuperar</a></span>
                                </div>

                                <div class="py-4">
                                    <button className="block w-full max-w-xs mx-auto bg-yellow-500 hover:bg-yellow-600 focus:bg-yellow-600 text-white rounded-lg px-2 py-2 font-semibold">INICIAR SESIÓN</button>
                                </div>
                                <div className="text-center">
                                    <label for="" className="text-xs font-semibold px-1 text-gray-500 py-1">¿No tienes cuenta?</label>
