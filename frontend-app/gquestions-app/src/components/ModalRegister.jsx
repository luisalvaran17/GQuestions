...
class ModalRegister extends Component {
    ...
    render(){
        return (
            <div ref={this.divModal} class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <p class="text-sm text-gray-500">
                            Puedes ir a la pantalla de iniciar sesión e introducir tu correo electrónico y contraseña
                            </p>
                        </div>
                    </div>
                    </div>
