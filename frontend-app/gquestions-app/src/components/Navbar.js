  ...
  useEffect(() => {
    ...
    return (
      <div className='flex h-screen font-manrope font-semibold'>
        <nav class='xl:w-28 w-20 h-full flex flex-col items-center bg-white dark:bg-gray-800 pt-6 pb-2 border-r-2 mb-4 border-r-black'>
          <div>
          ...
          <ul class='mt-2 text-gray-700 dark:text-gray-400 capitalize'>
            ...
            <li ref={divRefButtonGeneracion} 
              class='mt-3 p-2 transition duration-300 hover:ring-2 hover:ring-yellowlight hover:text-yellow-800
              hover:bg-yellowlight hover:opacity-75 dark-hover:text-yellow-300 rounded-lg'
            >
              <button onClick={handleClickGeneracion}  class='flex flex-col items-center ml-2 focus:outline-none'>
                <svg
                  aria-hidden='true'
                  focusable='false'
                  data-prefix='far'
                ...
                <span class='text-xs mt-2'>Generación</span>
              </button>
            </li>
            
            <li ref={divRefButtonDashboard} class='mt-3 p-2 transition duration-300 hover:ring-2 hover:ring-yellowlight hover:text-yellow-800
              hover:bg-yellowlight hover:opacity-75 dark-hover:text-yellow-300 rounded-lg'>
              <button onClick={handleClickDashboard}  class='flex flex-col items-center ml-2 focus:outline-none'>
            ...
            <li ref={divRefButtonEstadisticas} 
              ...
              hover:bg-yellowlight hover:opacity-75 dark-hover:text-yellow-300 rounded-lg'
            >
              <button onClick={handleClickEstadisticas} class='flex flex-col items-center ml-2 focus:outline-none'>
                <svg
                  aria-hidden='true'
                  focusable='false'
                  data-prefix='far'
                ...
                <span class='text-xs mt-2'>Estadísticas</span>
              </button>
            </li>


            <li ref={divRefButtonAjustes} class='mt-3 p-2 transition duration-300 hover:ring-2 hover:ring-yellowlight hover:text-yellow-800
              hover:bg-yellowlight hover:opacity-75 dark-hover:text-yellow-300 rounded-lg'>
              <button onClick={handleClickAjustes}  class='flex flex-col items-center ml-2 focus:outline-none'>
                <svg
                ...
                <span class='text-xs mt-2 px-2'>Ajustes</span>
              </button>
            </li>
          </ul>

          <div
            class='mt-auto flex items-center p-2 text-yellow-700 bg-yellowlight
			dark:text-yellow-500 rounded-full transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 mb-1'
          >
            <Link to='/' clasn>
          ...
          <div className="mb-4">
              <a className='text-xs'>Cerrar sesión</a>
            </div>
        </nav>
      </div>
    );
