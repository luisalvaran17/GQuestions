                ...
                <div>
                  ...
                  <div className='grid w-full grid-cols-12 gap-x-2 grid-rows-2 grid-cols-1 text-center items-center'>
                    <div className='py-1 lg:py-4 col-span-12'>
                      <button
                        type='submit'
                        className='w-10 z-10 pl-1 block w-full max-w-xs mx-auto bg-yellow-500 hover:bg-yellow-600 focus:bg-yellow-600 text-white rounded-lg px-2 py-2 font-semibold'
