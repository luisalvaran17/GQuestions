...
class Register extends Component {
    ...
    handleClickRegister = (e) => {
        ...
        fetch("http://127.0.0.1:8000/api/exist-user/"+this.state.usuario.email,{
            method: "GET",
        ...
        .then((data) => {
            if(data.ok === true){
                ...
                if(!this.checkEmptyFields() && this.checkPasswords() && this.checkStrengthPassword()){
    ...
    checkEmptyFields = () => {
        if(this.state.usuario.first_name === "" || this.state.usuario.last_name === ""
        || this.state.usuario.email === "" || this.state.usuario.password === "" 
    ...
    checkPasswords = () => {
        if(this.state.usuario.password === this.state.confirmation_pass.password2){
            return true
        }
        else{
                ...
                <div className="container mx-auto font-manrope">
                    <div className="min-w-screen min-h-screen flex items-center justify-center px-8 py-4 xl:px-64 md:py-32 text-xs sm:text-base">
                        <Helmet>
                            ...
                            <script src="https://kit.fontawesome.com/51d411da80.js" crossorigin="anonymous"></script>
                                ...
                                <form onSubmit={this.handleSubmit} className="w-full lg:w-1/2 py-10 px-5 lg:px-10">
                                    ...
                                    <div>
                                        <div className="grid grid-rows-2 grid-cols-1 md:flex -mx-3 ">
                                            ...
                                            <div className="md:w-1/2 px-3 mb-3">
                                                <label htmlFor="" className="text-xs font-semibold px-1">Apellido</label>
                                                <div className="flex">
                                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                    <input 
                                                    type="text"
                                        ...
                                        <div className="flex -mx-3">
                                            <div className="w-1/2 px-3 mb-3">
                                                <label htmlFor="" className="text-xs font-semibold px-1">Tipo de cuenta</label>
                                                <div className="flex">
                                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                    <select 
                                                        type="text"
                                        ...
                                        <div ref={this.divRefEmptyFields} className="hidden animate-pulse mt-0 relative py-3 pl-4 pr-10 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                                            ...
                                            <div ref={this.divRefPasswordsNoMatch} className="hidden animate-pulse mt-0 relative py-3 pl-4 pr-10 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                                                <p className="text-sm">Las contraseñas no coinciden</p>
                                                <span className="absolute inset-y-0 right-0 flex items-center mr-4" onClick={this.addClassPasswordsNoMatch}>
                                                    <svg className="w-4 h-4 fill-current" role="button" viewBox="0 0 20 20"><path d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" fillRule="evenodd"></path></svg>
                                                </span>
                                            </div>
                                            <div ref={this.divRefUser} className="hidden animate-pulse mt-0 relative py-3 pl-4 pr-10 leading-normal text-green-700 bg-green-100 rounded-lg" role="alert">
                                                <p className="text-sm">Usuario registrado exitosamente</p>
                                                <span className="absolute inset-y-0 right-0 flex items-center mr-4" onClick={this.addClassUser}>
                                                    <svg className="w-4 h-4 fill-current" role="button" viewBox="0 0 20 20"><path d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" fillRule="evenodd"></path></svg>
                                                </span>
                                            </div>
                                            <div ref={this.divPasswordStrength} className="hidden animate-pulse mt-0 relative py-3 pl-4 pr-10 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                                                <p className="text-sm">La contraseña debe estar entre 6 y 12 caracteres</p>
                                        ...
                                        <div className="py-1 col-span-12 my-0 text-center">
                                            <GoogleRegister className="w-10 z-10 block w-full max-w-xs mx-auto border-blue-200 border-2 hover:bg-blue-300 focus:bg-blue-400 rounded-lg px-2 py-2 font-semibold"
                                        ...
                                        <div className="text-center">
                                            ...
                                            <span><Link to="/login" className="text-xs font-semibold px-1 text-blue-500 underline">Iniciar sesión</Link></span>
                                        </div>
                                    </div>
                                </form>
                            </div>
