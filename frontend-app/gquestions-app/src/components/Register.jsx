        ...
        return (
            <div className="container mx-auto font-manrope">
                <div className="min-w-screen min-h-screen flex items-center justify-center px-8 py-4 xl:px-64 md:py-32 text-xs sm:text-base">
                    ...
                    <div className="text-sm md:text-base bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
                                ...
                                <div>
                                    <div className="grid grid-rows-2 grid-cols-1 md:flex -mx-3 ">
                                        <div className="md:w-1/2 px-3 mb-3">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ingresa tu nombre"/>
                                            </div>
                                        </div>
                                        <div className="md:w-1/2 px-3 mb-3">
                                            ...
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ingresa tu apellido"/>
                                            </div>
                                        </div>
                                        ...
                                        <div className="w-full px-3 mb-3">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input
                                                    type="password"
                                                    id="password1"
                                                    className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-yellow-500" placeholder=""
                                                    name="password"
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-1/2 px-3 mb-3">
                                            ...
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                <select type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ingresa tu nombre">
                                    ...
                                    <div className="grid grid-rows-1 text-center items-center">
                                        <div className="py-1 col-span-12 my-0">
                                            <button type="submit" className="z-10 pl-1 block w-full mx-auto mb-4 bg-yellow-500 hover:bg-yellow-600 focus:bg-yellow-600 text-white rounded-lg px-2 py-2 font-semibold"
                                    ...
                                    <div className="py-1 col-span-12 my-0">
                                        <button type="submit" className="w-10 z-10 pl-1 block w-full mx-auto mb-4 border-blue-200 border-2 hover:bg-blue-300 focus:bg-blue-400 rounded-lg px-2 py-2 font-semibold"
                                                        onClick={this.handleClick}
