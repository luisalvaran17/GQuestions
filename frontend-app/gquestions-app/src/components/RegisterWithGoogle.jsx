...
class RegisterWithGoogle extends Component {
    ...
    handleClickAccept = (e) => {
        if(!this.checkEmptyFields() && this.checkPasswords() && this.checkStrengthPassword()){
            ...
            //console.log(profile)
            this.setState(Object.assign(this.state.usuario,{first_name:profile.givenName, last_name:profile.familyName,
            email:profile.email}));
                ...
                <div className="min-w-screen min-h-screen flex items-center justify-center px-8 py-4 xl:px-64 md:py-32 text-xs sm:text-base">
                    ...
                    <div className="text-sm md:text-md bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full md:w-1/2 overflow-hidden">
                        <div className="md:flex w-full">
                            ...
                            <form onSubmit={this.handleSubmit} className="w-full py-10 px-5 lg:px-10">
                                <div className="text-center mb-10">
                                    <h1 className="font-black text-2xl md:text-3xl mb-8 text-center text-gray-600">TERMINAR REGISTRO</h1>
                                </div>
                                <div>
