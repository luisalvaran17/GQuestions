 ...
 */}
            <div className="w-full h-full fixed block top-0 left-0 opacity-100 z-50">
                <span className="opacity-100 top-1/2 my-0 mx-auto block relative w-0 h-0" style={{ top: "50%" }}>
