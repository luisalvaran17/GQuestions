...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('generacion_pregunta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='gquestions_api.generacionpregunta')),
        ...
        migrations.CreateModel(
            name='TipoPregunta',
            fields=[
                ('generacion', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='gquestions_api.generacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gquestions_api.generacion')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('generacion_pregunta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gquestions_api.generacionpregunta')),
                ('generacion_texto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gquestions_api.generaciontexto')),
            ],
        ),
        migrations.CreateModel(
